...
public class MainController {
    ...
    public void initialize(Service service,Stage stage,Employee employee){
    ...
    private void initializeChallengeBoxes(){
        ...
        try{
            ...
            List<ChallengeDTO> filtered = service.getAllChallenges().stream().filter(x -> x.getMinimumAge() <= age && x.getMaximumAge() >= age).collect(Collectors.toList());
    ...
    private void initModel(){
        childrenModel.addAll(service.getAllChildren());
        challengesModel.addAll(service.getAllChallenges());
    }
    @FXML
    private void handleShowChildren(){
        try {
            ...
            Challenge challenge = service.getChallengeByProperties(challengeDTO.getMinimumAge(), challengeDTO.getMaximumAge(), challengeDTO.getName());
            ...
            challengeChildrenModel.addAll(service.getChildrenById(challenge.getId()));
            challengeChildrenView.setCellFactory(param -> new ChildCell());
